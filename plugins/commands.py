            ...
            for files in filedetails:
                ...
                buttons = [
                    [
                        ...
                        InlineKeyboardButton('More Bots', url='https://t.me/KGN_BOTS')
                    ]
                    ]
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        ...
                        InlineKeyboardButton("Other Bots", url="https://t.me/KGN_BOTS")
                    ],
                    [
